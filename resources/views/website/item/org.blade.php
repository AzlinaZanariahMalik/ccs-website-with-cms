 ...
 <section id="parallax">
    <div class="row justify-content-center">
          <div class="gradient"></div>   
            ...
            <div class="text-left">
                <h1 class="text-start">Organization</h1>
...
<div class="container p-3">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">{{str_replace("-"," ",$org_name)}}</li>
    </ol> 
  </nav>
    <div class="row gx-5 ">
      
      <div class="col-md-8 " id="academic">
        @livewire('website.shows.get-org', ['id' => Route::current()->parameter('id')])
