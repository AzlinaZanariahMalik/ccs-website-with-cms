      ...
      <!--MODALS--->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <h6 class="text-center">You are about to delete this Department</h6>
