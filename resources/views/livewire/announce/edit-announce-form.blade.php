...
<div class="data">
		<div class="content-data"> 
            ...
            <form wire:submit.prevent="UpdateAnnounce()" method="post" class="row g-3" >
                @csrf 
                ...
                <div class="info">
                    ...
                    <form wire:submit.prevent="UpdateAnnounceImg()" method="post" class="row g-3" enctype="multipart/form-data">
                    @csrf
                        ...
                        @endif    
                            ...
                            <div class="col-md-12">
                                ...
                                <label class="form-label">Announcement Image</label>
                                 <br>
                                 @if (!empty($an_image))
                                     <img width="100px" src="{{ url('storage/photos/announce/'. $an_image)}}" style="width:  150px;" class="img-fluid img-thumbnail mx-auto d-block"/>
                                @else
                                No Image
                                @endif
