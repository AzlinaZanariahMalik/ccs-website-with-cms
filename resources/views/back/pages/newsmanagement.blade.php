...
<section id="sidebar">
		...
		<ul class="side-menu">
			...
			@endif
			<li><a href="" class="active" ><img class="icon" src="{{'data:image/png;base64,'}}"/></i>&nbsp News
			<img class="icon-right" src="{{'data:image/png;base64,'}}"/></a>
				<ul class="side-dropdown">
	...
	<section id="content">
	   ...
	   <!---Adding News and Managing news for user without publish permission-->
		@if(auth()->user()->publish_permission == 0)
