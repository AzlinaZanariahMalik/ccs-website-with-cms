...
<section id="sidebar">
		...
		<ul class="side-menu">
			<li><a href="{{ route('admin.home')}}"><img class="icon" src="{{'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAAAXNSR0IArs4c6QAAAHlJREFUSEtjZKAxYKSx+Qx0t2A/AwODAw5fPWBgYFCEyhGrDsMH/wkEGczHxKobtQBngMITD3oqIjZsiVVH/ziYz8DAkIDD4wcYGBgcoXLEqqN/RqN6yYEeycTmUGLV0T+SiU1+xKob9cEgLCqIzaHEqhuGOZnqRQUAZX0oGXY3cFsAAAAASUVORK5CYII='}}"/>&nbsp&nbsp Dashboard</a></li>
