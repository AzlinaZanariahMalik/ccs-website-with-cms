...
<section id="sidebar">
		...
		<ul class="side-menu">
			...
			@endif
			@if(auth()->user()->rank == 1)
			<li><a href="{{ route('admin.deans-corner')}}" class="active"  ><img class="icon" src="{{'data:image/png;base64,'}}"/>&nbsp Dean's Corner</a></li>
			@endif
