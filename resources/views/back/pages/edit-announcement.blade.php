	...
	<section id="content">
		...
		<main>
			...
			<ul class="breadcrumbs">
				...
				<li><a href="#" class="active">Edit Announcement</a></li>
			
			</ul>
		
        <!---Adding New News-->
       @livewire('announce.edit-announce-form',['id' => Route::current()->parameter('id')])
