...
<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="{{ route('admin.certifications')}}" class="active"><img class="icon" src="{{'data:image/png;base64,'}}"/>&nbsp Certification</a></li>
